...
for path in image_paths:
    ...
    plt.subplot(1,3,3)
    plt.title("Gray KMeans Histogram")
    plt.hist(gray_kmeans.ravel(), bins=16)
    ...
    print("\n=== Sample Matrix (5x5) Grayscale Original ===")
    print(img_gray[:5, :5])

    print("\n=== Sample Matrix (5x5) Grayscale Uniform ===")
    print(gray_uniform[:5, :5])

    print("\n=== Sample Matrix (5x5) Grayscale KMeans ===")
    print(gray_kmeans[:5, :5])

    # Vektor histogram sederhana (16 level)
    hist_original, _ = np.histogram(img_gray, bins=16)
    hist_uniform, _ = np.histogram(gray_uniform, bins=16)
    hist_kmeans, _ = np.histogram(gray_kmeans, bins=16)

    print("\n=== Histogram Vector (16 bins) ===")
    print("Original :", hist_original)
    print("Uniform  :", hist_uniform)
    print("KMeans   :", hist_kmeans)
